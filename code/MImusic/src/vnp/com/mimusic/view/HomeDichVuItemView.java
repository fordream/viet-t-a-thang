...
public class HomeDichVuItemView extends LinearLayout {
	public HomeDichVuItemView(Context context) {
		super(context);
		init();
	}

	public HomeDichVuItemView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
